	...
	<form class="form-horizontal" id="form" method="post">
		<fieldset>
			...
			<div class="form-group">
				...
				<div class="col-md-10">
					<input type="text" id="table_no" name="table_no" value="<?php echo set_value('table_no'); ?>" class="form-control" >
			...
			<div class="form-group">
				...
				<div class="col-md-10">
					<input type="text" id="number_of_places" name="number_of_places" value="<?php echo set_value('number_of_places'); ?>" class="form-control" >
