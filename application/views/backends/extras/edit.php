...
<section class="content-header">
  <h1>
	...
	<small><?php echo lang('msg_edit_extras'); ?></small>
  </h1>
  <ol class="breadcrumb">
	<li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
    <li><a href="#"><?php echo lang('msg_dashboard'); ?></a></li>
	<li><a href="#"><?php echo lang('msg_extras'); ?></a></li>
	<li class="active"><?php echo lang('msg_edit_extras'); ?></li>
...
<section class="content">
    ...
    <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title"><?php echo lang('msg_edit_extras'); ?></h3>
        </div>
	...
	<form class="form-horizontal" id="form" method="post" enctype="multipart/form-data" action="<?php echo base_url().'admin/extras/edit_post';?>">
		...
		<div class="form-group">
			...
			<div class="controls col-sm-10">
				<input type="text" id="price" name="price" value="<?php echo $obj[0]->price;?>" class="form-control">
